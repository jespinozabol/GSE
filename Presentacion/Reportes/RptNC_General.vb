...
Public Class RptNC_General
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.RptNC_General.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptNC_General
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptNC_General = New RptNC_General()
        rpt.Site = Me.Site
        Return rpt
    End Function
