...
Public Class RptND_General
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.RptND_General.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptND_General
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptND_General = New RptND_General()
        rpt.Site = Me.Site
        Return rpt
    End Function
