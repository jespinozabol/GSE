...
Public Class RptLista_Creditos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.RptLista_Creditos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptLista_Creditos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptLista_Creditos = New RptLista_Creditos()
        rpt.Site = Me.Site
        Return rpt
    End Function
