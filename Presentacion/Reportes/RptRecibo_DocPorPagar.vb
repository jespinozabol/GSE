...
Public Class RptRecibo_DocPorPagar
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptRecibo_DocPorPagar.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.RptRecibo_DocPorPagar.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_numRecibo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRptRecibo_DocPorPagar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptRecibo_DocPorPagar = New RptRecibo_DocPorPagar()
        rpt.Site = Me.Site
        Return rpt
    End Function
