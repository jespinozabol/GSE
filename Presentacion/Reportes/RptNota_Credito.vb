...
Public Class RptNota_Credito
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.RptNota_Credito.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptNota_Credito
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptNota_Credito = New RptNota_Credito()
        rpt.Site = Me.Site
        Return rpt
    End Function
